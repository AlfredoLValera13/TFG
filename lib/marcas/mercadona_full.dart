...
class MercadonaFull extends StatefulWidget {
  const MercadonaFull({super.key});

  @override
  _MercadonaFull createState() => _MercadonaFull();
}

class _MercadonaFull extends State<MercadonaFull> {
  ...
  final List<Map<String, dynamic>> products = [
    {
      ...
      "name": "FURIOUS",
      "price": 0.65,
      "image": "lib/assets/images/mercadona/furious-Photoroom.png-Photoroom.png",
      "nutrition": {
        "Porción": "500 ml",
        "Calorías": "110",
        "Grasas Totales": "0g",
    ...
    },
    {
      ...
      "name": "FULL TROPIC",
      "price": 0.65,
      "image": "lib/assets/images/mercadona/fulltropic-Photoroom.png-Photoroom.png",
      "nutrition": {
        "Porción": "500 ml",
        "Calorías": "45",
        "Grasas Totales": "0g",
    ...
    {
      "id": 108,
      "name": "EDRINK Hacendado 250 ML",
      "price": 0.35,
      "image": "lib/assets/images/mercadona/edrink_600x600-Photoroom.png-Photoroom.png",
      "nutrition": {
        "Porción": "500 ml",
        "Calorías": "45",
        "Grasas Totales": "0g",
    ...
    {
      "id": 109,
      "name": "EDRINK Hacendado 500 ML",
      "price": 0.35,
      "image": "lib/assets/images/mercadona/edrink500ml_600x600-Photoroom.png-Photoroom.png",
      "nutrition": {
        "Porción": "500 ml",
        "Calorías": "110",
        "Grasas Totales": "0g",
    ...
    {
      "id": 110,
      "name": "EDRINK ZERO Hacendado",
      "price": 0.35,
      "image": "lib/assets/images/mercadona/edrinkzero_600x600-Photoroom.png-Photoroom.png",
      "nutrition": {
        "Porción": "250 ml",
        "Calorías": "10",
        "Grasas Totales": "0g",
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('Mercadona', style: TextStyle(color: Colors.white)),
        backgroundColor: Colors.green,
        actions: [
          IconButton(
          ...
          Container(
            decoration: const BoxDecoration(
              image: DecorationImage(
                image: AssetImage('lib/assets/images/mercadona/mercadona.gif'),
                fit: BoxFit.cover,
              ),
            ),
              ...
              children: [
                ...
                AnimatedOpacity(
                  ...
                  child: Column(
                    children: [
                      Image.asset(
                        'lib/assets/images/mercadona/Mercadona-Photoroom.png',
                        height: 200,
                      ),
                      const Padding(
                        padding: EdgeInsets.all(16.0),
                        child: Text(
                          "En Mercadona, las bebidas energéticas como Furious y Full Tropical, que son populares por su buen equilibrio entre sabor y precio, proporcionando energía rápida con ingredientes estándar de la industria.",
